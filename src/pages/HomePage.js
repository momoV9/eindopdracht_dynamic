...
const HomePage = () => {
  ...
  return (
    <Wrapper>
      <Content>
        <Alert variant="info">
          <strong>Welcome to the world of anime!</strong> If you're an anime
          enthusiast, you've come to the right place. Explore a wide selection
          of your favorite anime series and discover new adventures. Whether
          you're into action, adventure, or any other genre, our collection has
